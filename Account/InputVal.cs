...
namespace Account
{
    public class InputVal:FormAcct  // Class for input validations 
    {
        ...
        public void inputVal()         // parameter of user input 
        {
            labelAct.Text = temp;

            if (double.TryParse(temp, out testI) == true) // if the user's input is a double, then :
            {
                ...
                {
                    doubleTrue = false;
                    labelAct.Text = "Please enter a valid number.";
                }
